...
%>
	...
	<form:form id="change-area-form" cssClass="form-general" modelAttribute="newArea" action="${saveAreaUrl}" >
		...
		<div class="row cols-1 cf clearfix">
            <aui:button-row>
                <button class="btn btn-primary" type="submit">Lägg till nytt geografiskt område</button>
            </aui:button-row>
		</div>
	</form:form>
...
--%>
            <aui:button-row>
                <button class="btn btn-danger" type="submit">Ta bort valt geografiskt område</button>
            </aui:button-row>
		</div>
	</form:form>
</div>
